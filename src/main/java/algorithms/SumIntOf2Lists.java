...
public class SumIntOf2Lists {
    private static List<Integer> sumLinkedList(LinkedList<Integer> l1, LinkedList<Integer> l2) {
    ...
    public static void main(String[] args) {
        LinkedList<Integer> l1 = new LinkedList<>(Arrays.asList(1, 4, 9, 3, 5, 6, 2, 4, 5, 6, 2));
        LinkedList<Integer> l2 = new LinkedList<>(Arrays.asList(9, 0, 0, 8, 5));
        List<Integer> expected = Arrays.asList(1, 4, 9, 3, 5, 7, 1, 4, 6, 4, 7);
        System.out.println(sumLinkedList(l1, l2).equals(expected));
        System.out.println(sumLinkedList(l1, l2));

        l1 = new LinkedList<>(Arrays.asList(9, 9, 9, 9, 9, 9, 9));
        l2 = new LinkedList<>(Arrays.asList(9, 9, 9, 9, 9, 9, 9));
        expected = Arrays.asList(1, 9, 9, 9, 9, 9, 9, 8);
        System.out.println(sumLinkedList(l1, l2).equals(expected));
        System.out.println(sumLinkedList(l1, l2));

        l1 = new LinkedList<>(Arrays.asList(9, 9, 9, 9, 9, 9, 9));
        l2 = new LinkedList<>(Arrays.asList(9, 9, 9, 9, 9, 9, 9, 9));
        expected = Arrays.asList(1, 0, 9, 9, 9, 9, 9, 9, 8);
        System.out.println(sumLinkedList(l1, l2).equals(expected));
        System.out.println(sumLinkedList(l1, l2));
    }
